...
<div data-role="page" class="type-home" id="page">
	...
	<div data-role="content-wrap">
    	...
    	<div data-role="content" data-theme="d" class="ui-page-full">
			<h1>About Me</h1><hr class="headerLine" />
        	<p>I believe that to gain the knowledge one has to experiement. I started working on the web around 3 years ago. Since then, I've worked on various things such as HTML, CSS, Java Script, PHP, ASP.net, CMS (Joomla, Drupal, WordPress, phpBB, Microsoft Sharepoint). Along the journey, I was able to gather knowlege from many talented and helping people.</p>
            <p>I am currently persuing my Masters in Computer Science from the <a href="http://www.cs.ttu.edu/">Department of Computer Science</a> at <a href="http://www.ttu.edu/"> Texas Tech University</a>, Lubbock, TX, USA.</p>
            <p>I would like to thank you to take the time you to learn more about me. I request you to have a look at my selected works on this website. Let me know if I can help you or you can use the contact form to just get in touch.</p>
